...
print'<BODY>'
print'<P style="border-radius:10px; text-align:center">If you would like to go back to the welcome page, click on the link below<br>'
print'<a href="http://www.cs.mcgill.ca/~ctrinh2/welcome.html">Click here go back to the welcome page</a></p>'


print'<P style="border-radius:10px; text-align:center">If you would like to create another survey, click on the link below<br>'
print'a href="http://www.cs.mcgill.ca/~tk04/surveyCreation.html">Click here to create a survey</a></p>'


print'<P style="border-radius:10px; text-align:center">If you would like to fill a survey, click on the link below<br>'
print'<a href="http://www.cs.mcgill.ca/~tko4/survey.html">Click here to fill a survey</a></p>'
